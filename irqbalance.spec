...
Version  : 1.9.0
Release  : 23
URL      : https://github.com/Irqbalance/irqbalance/archive/v1.9.0/irqbalance-1.9.0.tar.gz
Source0  : https://github.com/Irqbalance/irqbalance/archive/v1.9.0/irqbalance-1.9.0.tar.gz
...
%prep
%setup -q -n irqbalance-1.9.0
cd %{_builddir}/irqbalance-1.9.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655997908
...
cp %{_builddir}/irqbalance-1.9.0/COPYING %{buildroot}/usr/share/package-licenses/irqbalance/dfac199a7539a404407098a2541b9482279f690d
%make_install
